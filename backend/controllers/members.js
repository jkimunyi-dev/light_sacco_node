...
membersRoute.post("/members", (req, res) => {
  const {
    first_name,
    last_name,
    id_number,
...
membersRoute.get("/members", (req, res) => {
...
membersRoute.put("/members/:member_id", (req, res) => {
...
membersRoute.delete("/members/:member_id", (req, res) => {
  const memberId = req.params.member_id;
